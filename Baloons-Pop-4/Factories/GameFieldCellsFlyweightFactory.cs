namespace BaloonsPopsGame.Factories
{
    ...
    public static class GameFieldCellsFlyweightFactory
    {
        ...
        static GameFieldCellsFlyweightFactory()
        {
            ...
            GameFieldCellsFlyweightFactory.flywieghtCells.Add(2, new GameFieldCell(1, ConsoleColor.Black, ConsoleColor.Green));
            GameFieldCellsFlyweightFactory.flywieghtCells.Add(3, new GameFieldCell(1, ConsoleColor.White, ConsoleColor.Blue));
            GameFieldCellsFlyweightFactory.flywieghtCells.Add(4, new GameFieldCell(1, ConsoleColor.Black, ConsoleColor.Yellow));
        }
